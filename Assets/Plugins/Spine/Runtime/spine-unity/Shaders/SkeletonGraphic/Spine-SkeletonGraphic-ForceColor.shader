...
Shader "Spine/SkeletonGraphic-ForceColor"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #pragma multi_compile __ FORCE_COLOR
...
float _GrayPhase;
	...
	// as these would be wrong with modified alpha.
                ...
                float4 vertexColor =
                    PMAGammaToTargetSpaceSaturated(half4(TargetToGammaSpace(IN.color.rgb), IN.color.a));
                #endif
                OUT.color = vertexColor;
                #ifndef ENABLE_GRAYSCALE
                OUT.color *= float4(_Color.rgb * _Color.a, _Color.a);
